const request = require('request'),
    customCommands = require('../../user-config/commands/bravia-commands.json'),
    rawCommands = require('../../user-config/commands/raw/bravia-raw-commands.json'),
...
Bravia.prototype.executeCommands = function (commands) {
    ...
    this.checkPowerStatus(function (isOn) {
        ...
        let runCommandsFunction = function () {
            that.commandProcessor.executeCommands('Bravia', commands, that.processCommand.bind(that))
        };
